  ...
  return (
     <div className="flex items-center justify-center">
        <div className="absolute bottom-15 w-[55vw] flex flex-col gap-3 rounded-2xl border border-gray-800 p-5">
          ...
          {/* message bar */}
          <div>
            <input onKeyDown={handleKeypress} value={prompt} onChange={handlechange} className="w-full p-1 focus:outline-0 " type="text" name="prompt" id="prompt" placeholder="Ask gemini" />
          </div>
          ...
          <div className="flex items-center justify-between opacity-60">
            ...
            <div>
              <button onClick={handlesubmit} className="hover:bg-gray-700 cursor-pointer flex px-2 py-2 rounded-full">
                {prompt ? <img className="w-6 h-6" src="https://img.icons8.com/?size=100&id=M3364bo7ll36&format=png&color=EBEBEB" alt="" /> : <img className="w-6 h-6" src="https://img.icons8.com/?size=100&id=9622&format=png&color=EBEBEB" alt="" />}
